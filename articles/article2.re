...
この技術書は、2024年5月現在でGPTの最新モデルであるGPT-4 omni (GPT-4o)を使ったユースケースとして、プレゼンテーション資料の拡張の検索を拡張したインテリジェントアプリの開発について述べています。GPT-4oはテキスト、画像、動画、音声を入出力できるマルチモーダルなモデルであり、本技術書の例では、テキストと画像を入力と受け取ることで従来のテキストのみによる資料検索の拡張を図っています。プレゼンテーション資料の検索を行いたい場合、Microsoftのエコシステムの中に限っても資料を探す方法は多岐にわたります。例えば、Bingでは職場向けの検索ができ、検索に関連するword、PowerPoint、SharePoint等の資料を探しだすことができます。Copilotを利用した社内文書検索では、CopilotやMicrosoft 365 CopilotがMicrosoft Graph APIを介してアクセスできるファイルの中から関連する資料を検索し、ドキュメントを得ることができます。また、SharePointのような社内のポータルサイトやTeamsによるコミュニケーションアプリ、Outlookなどのメールを通じた検索方法も一般的です。しかし、これらの従来の検索方法にはいくつかの制限があります。例えば、テキスト以外の情報を含む資料や、資料に含まれる図や画像に関する情報を利用した検索が困難です。現状では、テキスト情報に依存しており、テキスト以外の情報を持つ資料に対する検索精度や効率性に課題があります。そこで、これらの限界を克服し、プレゼンテーション資料の検索を拡張するためには、新たなアプローチが必要です。まず、GPT-4oの画像認識技術や自然言語処理技術を活用して、資料内の図や画像に対する検索機能を強化することが考えられます。これにより、テキスト以外の情報を含む資料に対する検索の精度と効率性を向上させることができます。さらに、資料のメタデータやタグ付けを活用して、テキスト以外の情報も含めた効果的な検索を実現することが重要です。これにより、資料の属性や特徴に基づいた高度な検索が可能になります。このように、新たな技術とアプローチを活用することで、従来のプレゼンテーション資料の検索方法の限界を克服し、より効率的で精度の高い検索体験を提供することが可能になり、これにより、組織内の知識共有や情報アクセスが向上し、業務効率の向上に貢献します。本技術書では、上記にある新しいアプローチを提案する内容になっています。また、提案では様々なAzureサービスを利用していますが、それぞれの製品に対する説明をしているため、Azure初学者の方でも理解しやすい内容になっています。この本ではGPT-4oでデプロイしたインテリジェントアプリを手軽に試せるようにテンプレート化しており、実際にご自身の環境で動かすことで簡単にGPT-4oの威力をご体感頂けます。そして、最終的には読者がGPT-4oを活用したインテリジェントアプリの開発に自信を持ち、実際のプロジェクトやビジネスに応用できるようになることをゴールとしています。

  # 目次- Azure 製品紹介- Azure AI Search - Azure AI Services - Azure OpenAI Services - Azure Functions - Azure Blob Storage - 検索を拡張したインテリジェントアプリの開発- アーキテクチャの解説- 実装手順- 利用方法- 今後の展望- おわりに  # Azure 製品紹介## Azure AI Search ### Azure AI Search とはAzure AI Search (旧称：Azure Cognitive Search) は、Azure のクラウドプラットフォーム上で提供される、高度な検索ソリューションです(注釈１)。このサービスを利用することで、豊富なデータセットからの効率的な情報検索を実現できます。

@<icon>{https://github.com/yus04/opc-iot-demo/assets/49590084/51842498-f373-43b2-b474-f34291d5611a} (注釈１)
...
//quote{
(注釈１)「Azure AI Search とは」https://learn.microsoft.com/ja-jp/azure/search/search-what-is-azure-search
//}

//quote{
(注釈2)「Azure AI Search でのセマンティック ランク付け」https://learn.microsoft.com/ja-jp/azure/search/semantic-search-overview
//}

//quote{
(注釈３)「Azure AI Search の機能」https://learn.microsoft.com/ja-jp/azure/search/search-features-list
//}
...
@<icon>{https://github.com/yus04/opc-iot-demo/assets/49590084/719e265e-bb0d-4942-956f-1bd63a2a042f} (注釈４)

Azure AI Search では、これらのデータソースからデータを取得し、利用可能な形式に変換してインデックスに格納することで、ユーザーが高速で効率的な検索を実行できるようになります。

//quote{
(注釈４)「データ ソース ギャラリー」https://learn.microsoft.com/ja-jp/azure/search/search-data-sources-gallery
//}
...
//quote{
(注釈５)「Azure AI Search の検索インデックス」https://learn.microsoft.com/ja-jp/azure/search/search-what-is-an-index
//}
...
@<icon>{https://github.com/yus04/opc-iot-demo/assets/49590084/497cc6db-7ce2-4b0f-a2c3-09a1067efd8f} (注釈６)
...
//quote{
(注釈６)「Azure AI Searchでのスキルセットの概念」https://learn.microsoft.com/ja-jp/azure/search/cognitive-search-working-with-skillsets
//}

//quote{
(注釈７)「インデックス付け中に追加処理を行うスキル (Azure AI Search)」https://learn.microsoft.com/ja-jp/azure/search/cognitive-search-predefined-skills
//}

//quote{
(注釈８)「Azure AI マルチサービス リソースを Azure AI Search のスキルセットにアタッチする」https://learn.microsoft.com/ja-jp/azure/search/cognitive-search-attach-cognitive-services?tabs=portal%2Cportal-remove
//}
...
//quote{
(注釈９)「Azure AI Search エンリッチメント パイプラインにカスタム スキルを追加する」https://learn.microsoft.com/ja-jp/azure/search/cognitive-search-custom-skill-interface
//}
...
@<icon>{https://github.com/yus04/opc-iot-demo/assets/49590084/8ec9be50-e117-4527-b26b-c1d5db418fb9} (注釈１０)
...
//quote{
(注釈１０)「インデックス作成のステージ」https://learn.microsoft.com/ja-jp/azure/search/search-indexer-overview#stages-of-indexing
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/b1b90987-7b2f-4082-ac91-b3370647580e][image]{
//}

//quote{
(注釈１１)「Azure AI サービスとは」https://learn.microsoft.com/ja-jp/azure/ai-services/what-are-ai-services#available-azure-ai-services
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/a160876b-9db7-48e3-b7fb-a334a41271c9][image]{
//}
...
//quote{
(注釈１２)「Azure OpenAI Service とは」https://learn.microsoft.com/ja-jp/azure/ai-services/openai/overview
//}

//quote{
(注釈１３)「Azure OpenAI Service モデル」https://learn.microsoft.com/ja-jp/azure/ai-services/openai/concepts/models#gpt-4-turbo
//}
...
//quote{
(注釈１４)「Azure OpenAI Service モデル」https://learn.microsoft.com/ja-jp/azure/ai-services/openai/concepts/models#gpt-4-and-gpt-4-turbo-models
//}
...
@<icon>{https://github.com/yus04/opc-iot-demo/assets/49590084/c0a445c2-2ea5-4aa3-b6af-1e74b4f7366f} (注釈１９)
...
//quote{
(注釈１５)「Azure Functions の概要」https://learn.microsoft.com/ja-jp/azure/azure-functions/functions-overview?pivots=programming-language-python
//}

//quote{
(注釈１６)「Azure Functions ランタイム バージョンの概要」https://learn.microsoft.com/ja-jp/azure/azure-functions/functions-versions?tabs=isolated-process%2Cv4&pivots=programming-language-python
//}

//quote{
(注釈１７)「Azure Functions のホスティング オプション」https://learn.microsoft.com/ja-jp/azure/azure-functions/functions-scale
//}

//quote{
(注釈１８)「Azure Functions でのトリガーとバインドの概念」https://learn.microsoft.com/ja-jp/azure/azure-functions/functions-triggers-bindings?tabs=isolated-process%2Cpython-v2&pivots=programming-language-python
//}

//quote{
(注釈１９)「Azure Functions のシナリオ」https://learn.microsoft.com/ja-jp/azure/azure-functions/functions-scenarios?pivots=programming-language-python
//}
...
@<icon>{https://github.com/yus04/opc-iot-demo/assets/49590084/643e71a3-5481-4c4d-97be-11a924dacefa} (注釈２０)
...
//quote{
(注釈２０)「Azure Blob Storage の概要」https://learn.microsoft.com/ja-jp/azure/storage/blobs/storage-blobs-introduction
//}

//quote{
(注釈２１)「ブロック BLOB のオブジェクト レプリケーション」https://learn.microsoft.com/ja-jp/azure/storage/blobs/object-replication-overview
//}

//quote{
(注釈２２)「保存データに対する Azure Storage 暗号化」https://learn.microsoft.com/ja-jp/azure/storage/common/storage-service-encryption
//}

//quote{
(注釈２３)「Microsoft Entra ID を使用して BLOB へのアクセスを認可する」https://learn.microsoft.com/ja-jp/azure/storage/blobs/authorize-access-azure-active-directory
//}

//quote{
(注釈２４)「BLOB データのアクセス層」https://learn.microsoft.com/ja-jp/azure/storage/blobs/access-tiers-overview
//}

  # 検索を拡張したインテリジェントアプリの開発ここから本題である、Azure AI Search と GPT-4 omniを使ってプレゼンテーション資料の検索の拡張をしたインテリジェントアプリの開発について、アーキテクチャの解説、実際のアプリの実装手順、今後の展望について説明します。

== アーキテクチャの解説

アプリケーションのアーキテクチャは下図になり、5 つの Azure サービスを利用しています。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/69ffe12e-da98-495e-aa4e-90280a4bb740][image]{
//}
...
Request Access to Azure OpenAI Service https://customervoice.microsoft.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR7en2Ais5pxKtso_Pz4b1_xUNTZBNzRKNlVQSFhZMU9aV09EVzYxWFdORCQlQCN0PWcu
...
//quote{
(注釈２５)「Bicep とは」https://learn.microsoft.com/ja-jp/azure/azure-resource-manager/bicep/overview?tabs=bicep
//}

本書で扱うサンプルアプリケーションのソースコードが保存されているリポジトリはこちらになります。https://github.com/yus04/slide-search-app
...
//quote{
(注釈２６)「Azure Developer CLI とは」https://learn.microsoft.com/ja-jp/azure/developer/azure-developer-cli/overview
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/87969447-e2c8-4b91-ac6d-58f54d02bde1][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/8f2c0533-077c-4a81-8118-6478758fdc02][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/657b367a-2cf2-4ef0-87ef-dbcf20efda36][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/62b4b0f7-29bf-491f-8209-71a604cb362b][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/61d3d3cb-bdc3-4447-a2b4-b3860946434b][image]{
//}

(azd up を実行した後にいくつかの質問事項に回答し、Azureリソースのプロビジョニングが開始している様子)デプロイには10~15 分程度の時間がかりますが、最終的にはデプロイが完了し、以下の画面のような画面が表示されます。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/9eba88f0-96e9-4364-95db-e90f5b96bfe0][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/f2eb16d8-fd91-4978-957e-e36444b288c9][image]{
//}

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/a5a5b50e-7c87-42af-91ac-950bdcfba3ad][image]{
//}

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/dbdc1ced-bb76-43ad-9710-16420b9ea78f][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/636fff3d-132b-40ca-a3c0-0003e6e30185][image]{
//}

上のタブに「デモアプリの作成」があるので、選択したあとモーダルで表示される「CORSを有効にして実行する」を押します。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/7b3a27eb-d633-45d5-985a-33be0f22aa33][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/2bfaaed0-a612-47ab-a1fe-54c2d63bcbe4][image]{
//}

サイドバーはカスタマイズ不要なのでそのまま「次へ」を押します。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/f39011b8-15a6-448f-97fc-9fda2538913a][image]{
//}

候補のカスタマイズも不要なので、そのまま「デモアプリの作成」を行います。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/c921e2ea-9bb8-438b-9e93-390d485bac0e][image]{
//}

デモアプリの準備が完了したら、「ダウンロード」を押します。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/126eb444-c3e5-4b2e-86fa-e299ae4dd63e][image]{
//}

エクスプローラーのダウンロードを見るとAzSearchというファイルがあるので、選択する。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/060da3a2-5f14-422e-bc29-c5149bec93be][image]{
//}

以下のような画面が表示される。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/ed8e2f10-f29a-4f45-b0a7-b3f530a01013][image]{
//}

検索バーの右にある虫眼鏡のアイコンを選択すると、インデックスに登録されているプレゼンテーション資料の一覧が表示されれば、無事デモアプリの作成は成功です。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/144380bd-6ec4-4800-bdd0-e2d1fc72b140][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/f86c5d30-eba3-426d-9205-2a2ba0040c12][image]{
//}

「フロー図」で書かれた資料の検索

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/b27fcbf4-c602-4756-9793-9ec7ddb610a9][image]{
//}

「JISEC」の企業ロゴが載っている資料の検索

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/d4fc95fb-dc82-4579-ad88-7de31541fef5][image]{
//}

「ビル」の写真を含む資料の検索

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/173916da-58ca-4cfb-9d42-bc175aad7ca6][image]{
//}
...
GPT-4oのモデルは json モードの対象外のため(注釈２７)、回答はjson形式になるようプロンプトで指示を与えています。

//image[https://github.com/yus04/opc-iot-demo/assets/49590084/a2e877be-f574-4d04-abb2-a75223eb2b0f][image]{
//}

//quote{
(注釈２７)「JSON モードを使用する方法について説明します」https://learn.microsoft.com/ja-jp/azure/ai-services/openai/how-to/json-mode?tabs=python#json-mode-support
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/baf5f3fa-4870-471c-9b1a-1fcb497386e6][image]{
//}
...
//image[https://github.com/yus04/opc-iot-demo/assets/49590084/b628cf08-cbb4-45a6-b9a2-e522672744a5][image]{
//}
